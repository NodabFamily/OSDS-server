...
from .views import create_read_all_album, read_edit_delete_album, delete_photo, create_comment, edit_delete_comment, \
    do_undo_like, do_undo_bookmark, create_tag, read_family_photo, read_bookmark
app_name = "archives"
...
urlpatterns = [
    ...
    path("families/<int:family_id>/bookmarks/<int:user_id>", read_bookmark, name="read_bookmark"),
